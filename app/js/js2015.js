...
$(document).ready(function () {
    ...
    var parallaxObj = function parallaxObj() {
    ...
    $('.menu').on('click', function () {
        var ltMenu = new TimelineLite();
        $('.menu').toggleClass('menu-js-opened');
        if ($('.menu').hasClass('menu-js-opened')) {
            $('.menu__text').addClass('invisible');
            ltMenu.to('.hidden-menu', 0.5, { top: '0' }).staggerTo('.menu__nav a', .7, { x: '0', autoAlpha: 1 }, 0.1);
    ...
    closeMenu = function closeMenu() {
        var ltMenu = new TimelineLite();
        ltMenu.staggerTo('.menu__nav a', 0, { x: '-20', autoAlpha: 0 }, 0).to('.hidden-menu', 0.1, {
            top: '-100%', onCompleate: function onCompleate() {
    ...
    $('.offer label').on('click', function (e) {
    ...
    $(window).on('scroll', function () {
        var topOffset = $('#offer')[0].getBoundingClientRect().top;
    ...
    var sceneChange = new ScrollMagic.Scene({ triggerElement: '.change', reverse: false, offset: 0 });
    var ltChange = new TimelineLite();
    sceneChange.setTween(ltChange).addTo(controller);

    var sceneWTT = new ScrollMagic.Scene({ triggerElement: '#whatIsThat', reverse: false, offset: 200 });
    var ltWTT = new TimelineLite();
    sceneWTT.setTween(ltWTT).addTo(controller);

    var sceneWYNT = new ScrollMagic.Scene({ triggerElement: '#whyYouNeedThat', reverse: false, offset: 200 });
    var ltWYNT = new TimelineLite();
    sceneWYNT.setTween(ltWYNT).addTo(controller);

    var sceneBus = new ScrollMagic.Scene({ triggerElement: '#business', reverse: false, offset: 200 });
    var ltBus = new TimelineLite();
    sceneBus.setTween(ltBus).addTo(controller);

    var sceneFirs = new ScrollMagic.Scene({ triggerElement: '#first', reverse: false, offset: 200 });
    var ltFirst = new TimelineLite();
    sceneFirs.setTween(ltFirst).addTo(controller);
    if (window.innerWidth >= 768) {
        ltChange.from('.change__left', 0.8, { yPercent: 30, ease: Power1.easeInOut, autoAlpha: 0, offset: 200 });

        ltWTT.from('.whatIsThat__right', 0.8, { yPercent: 20, ease: Power1.easeInOut, autoAlpha: 0, offset: 200 });

        ltWYNT.from('.whyYouNeedThat__left', 0.8, { yPercent: 20, ease: Power1.easeInOut, autoAlpha: 0, offset: 200 });

        ltBus.from('.business__left', 0.8, { yPercent: 20, ease: Power1.easeInOut, autoAlpha: 0, offset: 200 });

        ltFirst.from('.first__left', 0.8, { yPercent: 20, ease: Power1.easeInOut, autoAlpha: 0, offset: 200 });
    }
    ...
    var input = {
        valField: function valField() {
            ...
            var length = function length() {
                return $(_this).attr('id') === 'InputPhone' ? 19 : 2;
            };
    ...
    $('#form').on('submit', function (e) {
        ...
        if (formValid) {
            ...
            $.post("https://dekurs.com.ua/api/mail/send", userData, onAjaxSuccess);
